...
//	private static Log4jLog logger = Log4jLog.getLog(ClasspathPackageScanner.class);
...
//		}
	...
	public static void main(String[] args) throws Exception {
		PackageScanner scan = new ClasspathPackageScanner("cn.ebooboo");
